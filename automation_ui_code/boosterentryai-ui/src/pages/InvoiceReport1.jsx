...
───────────────────────────────────────────────────────────────── */
function MiniBar({ completed, ahr, failed, total }) {
...
export default function InvoiceReport() {
  ...
  const summary    = data?.summary  || { total: 0, completed: 0, completed_ahr: 0, failed: 0 };
                ...
                {branchRows.map((b, i) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3 min-w-[140px]">
                      <MiniBar completed={b.completed} ahr={b.completed_ahr} failed={b.failed} total={b.total} />
