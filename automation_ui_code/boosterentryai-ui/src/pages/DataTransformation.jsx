            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="GSTType">GSTType</option>
                  <option value="EWayBillNo">EWayBillNo</option>
                  <option value="Invoice Date">Invoice Date</option>
                  <option value="E-Way Bill Date">E-Way Bill Date</option>
                  <option value="Get Rate">Get Rate</option>
                  <option value="GoodsType">GoodsType</option>
                  <option value="DeliveryaddressState">DeliveryaddressState</option>
