    ...
    try:
        ...
        count_query = f"""
            SELECT
                ...
                COUNT(*) FILTER (WHERE d.erp_entry_status ILIKE 'Failed' OR d.data_extraction_status ILIKE 'Failed') AS failed,
                COUNT(*) FILTER (WHERE d.erp_entry_status ILIKE 'Duplicate')     AS duplicate
        ...
        row = cur.fetchone()
        total, completed, completed_ahr, failed, duplicate = row
